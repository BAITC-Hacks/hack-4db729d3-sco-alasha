...
1. **Обрыв на 4-м колене.** Проверено на данных: ребро всегда записано на колене *(глубина плательщика + 1)*. Значит,
   ...
   - **качество проверено на отложенной выборке (25%)**: ROC-AUC **0.71** против 0.66 у однофакторного
     бейзлайна «число плательщиков» — модель использует несколько признаков и лучше простого правила;
